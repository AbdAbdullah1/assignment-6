...
const createSlider = () => {
  ...
  // MInus Time
  let inputDuration = document.getElementById('doration').value
  if (inputDuration < 0) {
    alert('Time cannot Be Minus!!!!.....Default Time duration is set for 1 second')
